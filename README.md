...
-   **`Header.jsx`**
    ...
    -   **Izmantotās klases (no `Header.css`)**:
        ...
        -   (Atsevišķas mobilo izkārtojuma klases no `@media` vaicājumiem)
...
-   **`RichTextEditor.jsx`**
    -   **Apraksts**: Teksta redaktora komponente, kas izmanto TipTap bibliotēru. Nodrošina bagātinātā teksta rediģēšanas iespējas (treknraksts, kursīvs, saraksti, saites, krāsas utt.) un var darboties arī tikai skatīšanās režīmā.
